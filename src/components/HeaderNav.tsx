...
export default function HeaderNav({activeSection,}: {activeSection: string;}) {
  return (
    ...
    >
      <div className="rounded-none sm:rounded-full border border-white/40 bg-white/70 sm:bg-white/70 backdrop-blur-xl shadow-lg shadow-indigo-500/20">
        <nav className="flex items-center justify-center h-16 sm:h-14 px-4 sm:px-12">
