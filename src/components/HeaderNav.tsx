...
export default function HeaderNav({ activeSection }: { activeSection: string }) {
  return (
    <motion.header
      ...
      className="fixed top-6 left-1/2 z-50 w-full max-w-[40rem] -translate-x-1/2 px-4"
    >
      <div className="rounded-full border border-white/40 bg-white/30 backdrop-blur-xl shadow-lg shadow-indigo-500/20">
        <nav className="flex items-center justify-center h-14 sm:h-16 px-6 sm:px-12">
